...
type SecretFileMsg_OperType int32

const (
	SecretFileMsg_TYPE_C2C      SecretFileMsg_OperType = 0
	SecretFileMsg_TYPE_CONTACTS SecretFileMsg_OperType = 1
	SecretFileMsg_TYPE_GROUP    SecretFileMsg_OperType = 2
	SecretFileMsg_TYPE_NEARBA   SecretFileMsg_OperType = 3
	SecretFileMsg_TYPE_DISCU    SecretFileMsg_OperType = 4
	SecretFileMsg_TYPE_WPA      SecretFileMsg_OperType = 5
)

// Enum value maps for SecretFileMsg_OperType.
var (
	SecretFileMsg_OperType_name = map[int32]string{
		0: "TYPE_C2C",
		1: "TYPE_CONTACTS",
		2: "TYPE_GROUP",
		3: "TYPE_NEARBA",
	...
	SecretFileMsg_OperType_value = map[string]int32{
		"TYPE_C2C":      0,
		"TYPE_CONTACTS": 1,
		"TYPE_GROUP":    2,
		"TYPE_NEARBA":   3,
...
func (x SecretFileMsg_OperType) Enum() *SecretFileMsg_OperType {
	p := new(SecretFileMsg_OperType)
	*p = x
	return p
}

func (x SecretFileMsg_OperType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SecretFileMsg_OperType) Descriptor() protoreflect.EnumDescriptor {
	return file_msg_proto_enumTypes[1].Descriptor()
}

func (SecretFileMsg_OperType) Type() protoreflect.EnumType {
	return &file_msg_proto_enumTypes[1]
}

func (x SecretFileMsg_OperType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SecretFileMsg_OperType.Descriptor instead.
func (SecretFileMsg_OperType) EnumDescriptor() ([]byte, []int) {
	return file_msg_proto_rawDescGZIP(), []int{56, 0}
}
...
type Elem struct {
	...
	//FunFace funFace = 10;
	SecretFile *SecretFileMsg `protobuf:"bytes,11,opt,name=secretFile,proto3" json:"secretFile,omitempty"`
	...
	LocationInfo *LocationInfo `protobuf:"bytes,32,opt,name=locationInfo,proto3" json:"locationInfo,omitempty"`
	...
	HcFlashPic   *CustomFace   `protobuf:"bytes,38,opt,name=hcFlashPic,proto3" json:"hcFlashPic,omitempty"`
...
func (x *Elem) GetSecretFile() *SecretFileMsg {
	if x != nil {
		return x.SecretFile
	}
	return nil
...
func (x *Elem) GetLocationInfo() *LocationInfo {
	if x != nil {
...
func (x *Elem) GetHcFlashPic() *CustomFace {
	if x != nil {
		return x.HcFlashPic
	}
	return nil
...
type SecretFileMsg struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BytesFileKey               []byte          `protobuf:"bytes,1,opt,name=bytes_file_key,json=bytesFileKey,proto3" json:"bytes_file_key,omitempty"`
	Uint64FromUin              uint64          `protobuf:"varint,2,opt,name=uint64_from_uin,json=uint64FromUin,proto3" json:"uint64_from_uin,omitempty"`
	Uint64ToUin                uint64          `protobuf:"varint,3,opt,name=uint64_to_uin,json=uint64ToUin,proto3" json:"uint64_to_uin,omitempty"`
	Uint32Status               uint32          `protobuf:"varint,4,opt,name=uint32_status,json=uint32Status,proto3" json:"uint32_status,omitempty"`
	Uint32Ttl                  uint32          `protobuf:"varint,5,opt,name=uint32_ttl,json=uint32Ttl,proto3" json:"uint32_ttl,omitempty"`
	Uint32Type                 uint32          `protobuf:"varint,6,opt,name=uint32_type,json=uint32Type,proto3" json:"uint32_type,omitempty"`
	Uint32EncryptPreheadLength uint32          `protobuf:"varint,7,opt,name=uint32_encrypt_prehead_length,json=uint32EncryptPreheadLength,proto3" json:"uint32_encrypt_prehead_length,omitempty"`
	Uint32EncryptType          uint32          `protobuf:"varint,8,opt,name=uint32_encrypt_type,json=uint32EncryptType,proto3" json:"uint32_encrypt_type,omitempty"`
	BytesEncryptKey            []byte          `protobuf:"bytes,9,opt,name=bytes_encrypt_key,json=bytesEncryptKey,proto3" json:"bytes_encrypt_key,omitempty"`
	Uint32ReadTimes            uint32          `protobuf:"varint,10,opt,name=uint32_read_times,json=uint32ReadTimes,proto3" json:"uint32_read_times,omitempty"`
	Uint32LeftTime             uint32          `protobuf:"varint,11,opt,name=uint32_left_time,json=uint32LeftTime,proto3" json:"uint32_left_time,omitempty"`
	NotOnlineImage             *NotOnlineImage `protobuf:"bytes,12,opt,name=not_online_image,json=notOnlineImage,proto3" json:"not_online_image,omitempty"`
	//ElemFlags2 elem_flags2 = 13;
	Uint32Opertype  uint32 `protobuf:"varint,14,opt,name=uint32_opertype,json=uint32Opertype,proto3" json:"uint32_opertype,omitempty"`
	StrFromphonenum string `protobuf:"bytes,15,opt,name=str_fromphonenum,json=strFromphonenum,proto3" json:"str_fromphonenum,omitempty"`
}

func (x *SecretFileMsg) Reset() {
	*x = SecretFileMsg{}
	if protoimpl.UnsafeEnabled {
...
func (x *SecretFileMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SecretFileMsg) ProtoMessage() {}

func (x *SecretFileMsg) ProtoReflect() protoreflect.Message {
	mi := &file_msg_proto_msgTypes[56]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SecretFileMsg.ProtoReflect.Descriptor instead.
func (*SecretFileMsg) Descriptor() ([]byte, []int) {
	return file_msg_proto_rawDescGZIP(), []int{56}
}

func (x *SecretFileMsg) GetBytesFileKey() []byte {
	if x != nil {
		return x.BytesFileKey
	}
	return nil
}

func (x *SecretFileMsg) GetUint64FromUin() uint64 {
	if x != nil {
...
func (x *SecretFileMsg) GetUint64ToUin() uint64 {
	if x != nil {
...
func (x *SecretFileMsg) GetUint32Status() uint32 {
	if x != nil {
		return x.Uint32Status
	}
	return 0
}

func (x *SecretFileMsg) GetUint32Ttl() uint32 {
	if x != nil {
		return x.Uint32Ttl
	}
	return 0
...
func (x *SecretFileMsg) GetUint32Type() uint32 {
	if x != nil {
		return x.Uint32Type
	}
	return 0
...
func (x *SecretFileMsg) GetUint32EncryptPreheadLength() uint32 {
	if x != nil {
		return x.Uint32EncryptPreheadLength
	}
	return 0
}

func (x *SecretFileMsg) GetUint32EncryptType() uint32 {
	if x != nil {
		return x.Uint32EncryptType
	}
	return 0
}

func (x *SecretFileMsg) GetBytesEncryptKey() []byte {
	if x != nil {
		return x.BytesEncryptKey
	}
	return nil
}

func (x *SecretFileMsg) GetUint32ReadTimes() uint32 {
	if x != nil {
		return x.Uint32ReadTimes
	}
	return 0
}

func (x *SecretFileMsg) GetUint32LeftTime() uint32 {
	if x != nil {
		return x.Uint32LeftTime
	}
	return 0
}

func (x *SecretFileMsg) GetNotOnlineImage() *NotOnlineImage {
	if x != nil {
		return x.NotOnlineImage
	}
	return nil
...
func (x *SecretFileMsg) GetUint32Opertype() uint32 {
	if x != nil {
		return x.Uint32Opertype
	}
	return 0
}

func (x *SecretFileMsg) GetStrFromphonenum() string {
	if x != nil {
		return x.StrFromphonenum
	}
	return ""
}
...
type LocationInfo struct {
	...
	DoubleLongitude float64 `protobuf:"fixed64,1,opt,name=double_longitude,json=doubleLongitude,proto3" json:"double_longitude,omitempty"`
	DoubleLatitude  float64 `protobuf:"fixed64,2,opt,name=double_latitude,json=doubleLatitude,proto3" json:"double_latitude,omitempty"`
	BytesDesc       []byte  `protobuf:"bytes,3,opt,name=bytes_desc,json=bytesDesc,proto3" json:"bytes_desc,omitempty"`
}
...
func (x *LocationInfo) GetDoubleLongitude() float64 {
	if x != nil {
		return x.DoubleLongitude
	}
	return 0
}

func (x *LocationInfo) GetDoubleLatitude() float64 {
	if x != nil {
		return x.DoubleLatitude
	}
	return 0
}

func (x *LocationInfo) GetBytesDesc() []byte {
	if x != nil {
		return x.BytesDesc
	}
	return nil
...
var file_msg_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0b, 0x32, 0x04, 0x2e, 0x50, 0x74, 0x74, 0x52, 0x03, 0x70, 0x74, 0x74, 0x22, 0xfe,
	0x06, 0x0a, 0x04, 0x45, 0x6c, 0x65, 0x6d, 0x12, 0x19, 0x0a, 0x04, 0x74, 0x65, 0x78, 0x74, 0x18,
	...
	0x6d, 0x46, 0x61, 0x63, 0x65, 0x12, 0x2e, 0x0a, 0x0a, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x46,
	0x69, 0x6c, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x53, 0x65, 0x63, 0x72,
	0x65, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x4d, 0x73, 0x67, 0x52, 0x0a, 0x73, 0x65, 0x63, 0x72, 0x65,
	0x74, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x22, 0x0a, 0x07, 0x72, 0x69, 0x63, 0x68, 0x4d, 0x73, 0x67,
	...
	,
	...
	,
...
var file_msg_proto_msgTypes = make([]protoimpl.MessageInfo, 58)
var file_msg_proto_goTypes = []interface{}{
	(SyncFlag)(0),                 // 0: SyncFlag
	(SecretFileMsg_OperType)(0),   // 1: SecretFileMsg.OperType
	(*GetMessageRequest)(nil),     // 2: GetMessageRequest
	(*SendMessageRequest)(nil),    // 3: SendMessageRequest
	(*SendMessageResponse)(nil),   // 4: SendMessageResponse
	(*MsgWithDrawReq)(nil),        // 5: MsgWithDrawReq
	(*C2CMsgWithDrawReq)(nil),     // 6: C2CMsgWithDrawReq
	(*GroupMsgWithDrawReq)(nil),   // 7: GroupMsgWithDrawReq
	(*GroupMsgInfo)(nil),          // 8: GroupMsgInfo
	(*C2CMsgInfo)(nil),            // 9: C2CMsgInfo
	(*RoutingHead)(nil),           // 10: RoutingHead
	(*C2C)(nil),                   // 11: C2C
	(*Grp)(nil),                   // 12: Grp
	(*GrpTmp)(nil),                // 13: GrpTmp
	(*MsgCtrl)(nil),               // 14: MsgCtrl
	(*GetMessageResponse)(nil),    // 15: GetMessageResponse
	(*PushMessagePacket)(nil),     // 16: PushMessagePacket
	(*UinPairMessage)(nil),        // 17: UinPairMessage
	(*Message)(nil),               // 18: Message
	(*MessageBody)(nil),           // 19: MessageBody
	(*RichText)(nil),              // 20: RichText
	(*Elem)(nil),                  // 21: Elem
	(*CommonElem)(nil),            // 22: CommonElem
	(*QQWalletMsg)(nil),           // 23: QQWalletMsg
	(*QQWalletAioBody)(nil),       // 24: QQWalletAioBody
	(*QQWalletAioElem)(nil),       // 25: QQWalletAioElem
	(*RichMsg)(nil),               // 26: RichMsg
	(*CustomElem)(nil),            // 27: CustomElem
	(*Text)(nil),                  // 28: Text
	(*Attr)(nil),                  // 29: Attr
	(*Ptt)(nil),                   // 30: Ptt
	(*OnlineImage)(nil),           // 31: OnlineImage
	(*NotOnlineImage)(nil),        // 32: NotOnlineImage
	(*NotOnlineFile)(nil),         // 33: NotOnlineFile
	(*TransElem)(nil),             // 34: TransElem
	(*ExtraInfo)(nil),             // 35: ExtraInfo
	(*GroupFile)(nil),             // 36: GroupFile
	(*AnonymousGroupMessage)(nil), // 37: AnonymousGroupMessage
	(*VideoFile)(nil),             // 38: VideoFile
	(*SourceMsg)(nil),             // 39: SourceMsg
	(*Face)(nil),                  // 40: Face
	(*LightAppElem)(nil),          // 41: LightAppElem
	(*CustomFace)(nil),            // 42: CustomFace
	(*ContentHead)(nil),           // 43: ContentHead
	(*MessageHead)(nil),           // 44: MessageHead
	(*GroupInfo)(nil),             // 45: GroupInfo
	(*DiscussInfo)(nil),           // 46: DiscussInfo
	(*MutilTransHead)(nil),        // 47: MutilTransHead
	(*C2CTempMessageHead)(nil),    // 48: C2CTempMessageHead
	(*InstCtrl)(nil),              // 49: InstCtrl
	(*InstInfo)(nil),              // 50: InstInfo
	(*ExtGroupKeyInfo)(nil),       // 51: ExtGroupKeyInfo
	(*SyncCookie)(nil),            // 52: SyncCookie
	(*TransMsgInfo)(nil),          // 53: TransMsgInfo
	(*GeneralFlags)(nil),          // 54: GeneralFlags
	(*PbMultiMsgItem)(nil),        // 55: PbMultiMsgItem
	(*PbMultiMsgNew)(nil),         // 56: PbMultiMsgNew
	(*PbMultiMsgTransmit)(nil),    // 57: PbMultiMsgTransmit
	(*SecretFileMsg)(nil),         // 58: SecretFileMsg
	(*LocationInfo)(nil),          // 59: LocationInfo
}
var file_msg_proto_depIdxs = []int32{
	0,  // 0: GetMessageRequest.syncFlag:type_name -> SyncFlag
	10, // 1: SendMessageRequest.routingHead:type_name -> RoutingHead
	43, // 2: SendMessageRequest.contentHead:type_name -> ContentHead
	19, // 3: SendMessageRequest.msgBody:type_name -> MessageBody
	14, // 4: SendMessageRequest.msgCtrl:type_name -> MsgCtrl
	6,  // 5: MsgWithDrawReq.c2cWithDraw:type_name -> C2CMsgWithDrawReq
	7,  // 6: MsgWithDrawReq.groupWithDraw:type_name -> GroupMsgWithDrawReq
	9,  // 7: C2CMsgWithDrawReq.msgInfo:type_name -> C2CMsgInfo
	8,  // 8: GroupMsgWithDrawReq.msgList:type_name -> GroupMsgInfo
	10, // 9: C2CMsgInfo.routingHead:type_name -> RoutingHead
	11, // 10: RoutingHead.c2c:type_name -> C2C
	12, // 11: RoutingHead.grp:type_name -> Grp
	13, // 12: RoutingHead.grpTmp:type_name -> GrpTmp
	0,  // 13: GetMessageResponse.syncFlag:type_name -> SyncFlag
	17, // 14: GetMessageResponse.uinPairMsgs:type_name -> UinPairMessage
	18, // 15: PushMessagePacket.message:type_name -> Message
	18, // 16: UinPairMessage.messages:type_name -> Message
	44, // 17: Message.head:type_name -> MessageHead
	43, // 18: Message.content:type_name -> ContentHead
	19, // 19: Message.body:type_name -> MessageBody
	20, // 20: MessageBody.richText:type_name -> RichText
	29, // 21: RichText.attr:type_name -> Attr
	21, // 22: RichText.elems:type_name -> Elem
	33, // 23: RichText.notOnlineFile:type_name -> NotOnlineFile
	30, // 24: RichText.ptt:type_name -> Ptt
	28, // 25: Elem.text:type_name -> Text
	40, // 26: Elem.face:type_name -> Face
	31, // 27: Elem.onlineImage:type_name -> OnlineImage
	32, // 28: Elem.notOnlineImage:type_name -> NotOnlineImage
	34, // 29: Elem.transElemInfo:type_name -> TransElem
	42, // 30: Elem.customFace:type_name -> CustomFace
	58, // 31: Elem.secretFile:type_name -> SecretFileMsg
	26, // 32: Elem.richMsg:type_name -> RichMsg
	36, // 33: Elem.groupFile:type_name -> GroupFile
	35, // 34: Elem.extraInfo:type_name -> ExtraInfo
	38, // 35: Elem.videoFile:type_name -> VideoFile
	37, // 36: Elem.anonGroupMsg:type_name -> AnonymousGroupMessage
	23, // 37: Elem.QQWalletMsg:type_name -> QQWalletMsg
	27, // 38: Elem.customElem:type_name -> CustomElem
	59, // 39: Elem.locationInfo:type_name -> LocationInfo
	54, // 40: Elem.generalFlags:type_name -> GeneralFlags
	42, // 41: Elem.hcFlashPic:type_name -> CustomFace
	39, // 42: Elem.srcMsg:type_name -> SourceMsg
	41, // 43: Elem.lightApp:type_name -> LightAppElem
	22, // 44: Elem.commonElem:type_name -> CommonElem
	24, // 45: QQWalletMsg.aioBody:type_name -> QQWalletAioBody
	25, // 46: QQWalletAioBody.sender:type_name -> QQWalletAioElem
	25, // 47: QQWalletAioBody.receiver:type_name -> QQWalletAioElem
	21, // 48: SourceMsg.elems:type_name -> Elem
	48, // 49: MessageHead.c2cTmpMsgHead:type_name -> C2CTempMessageHead
	45, // 50: MessageHead.groupInfo:type_name -> GroupInfo
	46, // 51: MessageHead.discussInfo:type_name -> DiscussInfo
	47, // 52: MessageHead.mutiltransHead:type_name -> MutilTransHead
	49, // 53: MessageHead.msgInstCtrl:type_name -> InstCtrl
	51, // 54: MessageHead.extGroupKeyInfo:type_name -> ExtGroupKeyInfo
	50, // 55: InstCtrl.msgSendToInst:type_name -> InstInfo
	50, // 56: InstCtrl.msgExcludeInst:type_name -> InstInfo
	50, // 57: InstCtrl.msgFromInst:type_name -> InstInfo
	51, // 58: TransMsgInfo.extGroupKeyInfo:type_name -> ExtGroupKeyInfo
	18, // 59: PbMultiMsgNew.msg:type_name -> Message
	18, // 60: PbMultiMsgTransmit.msg:type_name -> Message
	55, // 61: PbMultiMsgTransmit.pbItemList:type_name -> PbMultiMsgItem
	32, // 62: SecretFileMsg.not_online_image:type_name -> NotOnlineImage
